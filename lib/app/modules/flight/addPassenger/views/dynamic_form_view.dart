...
class DynamicForm extends StatelessWidget {
  ...
  List<Widget> _generateFormFields(
    ...
    // formWidgets.add(
    //   DropdownButtonFormField<String>(
    //     decoration: const InputDecoration(labelText: "Country Phone Code"),
    //     items: getCountryPhoneCodeItems(),
    //     onChanged: (value) {
    //       dynamicFormController.selectedCountryCode.value = value!;
    //     },
    //   ),
    // );
    formWidgets.add(const SizedBox(height: 10));

    // Add "Country Code" field manually after the dynamic fields
    // formWidgets.add(
    //   DropdownButtonFormField<String>(
    //     decoration: const InputDecoration(labelText: "Country Phone Code"),
    //     items: getCountryPhoneCodeItems(), // Static country codes
    //     onChanged: (value) {
...
//////////////////well working form without CountryCode field//////////////////////
// class DynamicForm extends StatelessWidget {
//   final Map<String, dynamic> formData; // Fields from the API response
//   final DynamicFormController dynamicFormController =
//       Get.put(DynamicFormController());
...
//         items:
//             getCountryPhoneCodeItems(), // Define this method to provide country codes
//         onChanged: (value) {
//           dynamicFormController.selectedCountries[passengerIndex] = value!;
//         },
//       ),
