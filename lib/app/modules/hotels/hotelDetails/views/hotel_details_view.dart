...
import 'package:flightbooking/app/modules/hotels/searchHotels/controllers/search_hotels_controller.dart';
...
class HotelDetailsView extends StatelessWidget {
  final HotelsRepository hotelsRepository = HotelsRepository();
  final SearchHotelsController searchHotelsController =
      SearchHotelsController();

  HotelDetailsView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hotel Search Results'),
      ),
      body: FutureBuilder<HotelSearchResponseModel>(
        future:
            searchHotelsController.getSearchedHotelData(), // Fetch hotels data
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: hotel.serviceInfo.thumbnail.isNotEmpty
                        ? Image.network(hotel.serviceInfo.thumbnail,
                            width: 50, height: 50)
                        : Icon(Icons.hotel),
                    title: Text(hotel.serviceInfo.title),
                    subtitle: Text(hotel.serviceInfo.address),
                    trailing: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
                            '${hotel.priceInfo.currencySymbol}${hotel.priceInfo.payable.toStringAsFixed(2)}'),
                        Text('${hotel.serviceInfo.star} stars'),
                      ],
                    ),
                    onTap: () {
                      // Handle hotel tap (e.g., navigate to hotel details page)
                    },
                  ),
                );
              },
...
// class HotelDetailsView extends StatelessWidget {
//   final Hotel
//       hotel; //can we do the same things without this final onbeject of Hotel class i just don't want to
//   //it as required in contstructor
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text(hotel.serviceInfo.title)),
//       body: Padding(
...
//           children: [
//             // Hotel Image
//             hotel.serviceInfo.thumbnail.isNotEmpty
//                 ? Image.network(
//                     hotel.serviceInfo.thumbnail,
//                     fit: BoxFit.cover,
//                     height: 200,
//                     width: double.infinity,
//                   )
//                 : Icon(Icons.hotel, size: 200),

//             SizedBox(height: 16),

//             // Hotel Name and Stars
//             Text(
//               hotel.serviceInfo.title,
//               style: TextStyle(
//                 fontSize: 24,
...
//             SizedBox(height: 8),
//             Row(
//               children: List.generate(hotel.serviceInfo.star, (index) {
...
//             // Price and Avg Night Price
//             Row(
//               mainAxisAlignment: MainAxisAlignment.spaceBetween,
//               children: [
//                 Text(
//                   "USD ${hotel.priceInfo.payable.toStringAsFixed(2)}",
//                   style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
//                 ),
//                 Text(
//                   "Avg/Night: USD ${hotel.priceInfo.payable.toStringAsFixed(2)}",
