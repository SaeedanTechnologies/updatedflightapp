...
import 'package:flightbooking/app/modules/Event/views/event_view.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.bottomSheet(const MyPopup(type: 'country'));
                  },
                  child: Row(
                    children: [
                ...
                // Obx(() {
                //   if (controller.selectedNationality.value.isEmpty) {
                ...
                GestureDetector(
                  onTap: () {
                    Get.bottomSheet(const MyPopup(type: 'city'));
                  },
                  child: Row(
                    children: [
