      ...
      child: Column(
        ...
        children: [
          ...
          Row(children: [
            ...
            10.widthBox,
            Obx(() => Text(
                  controller.departureCounrty.value.isEmpty
                      ? 'Departure Country'
                      : controller.departureCounrty.value,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 14.sp,
                    fontFamily: 'Poppins',
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    "Search ${widget.type == 'departure' ? 'departure' : 'destination'}",
                suffixIcon: const Icon(Icons.search, color: Colors.grey),
              ),
            ),
            const SizedBox(height: 20),
            FutureBuilder(
              future: widget.type == 'departure'
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  final data = widget.type == 'departure'
