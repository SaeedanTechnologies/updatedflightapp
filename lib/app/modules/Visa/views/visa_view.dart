      ...
      child: Column(
        ...
        children: [
          ...
          Row(children: [
            ...
            10.widthBox,
            Obx(() => Text(
                  controller.yourCountry.value.isEmpty
                      ? 'Your Country'
                      : controller.yourCountry.value,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 14.sp,
                    fontFamily: 'Poppins',
          ...
          Row(children: [
            ...
            10.widthBox,
            Obx(() => Text(
                  controller.passportCountry.value.isEmpty
                      ? 'select passport country'
                      : controller.passportCountry.value,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 14.sp,
                    fontFamily: 'Poppins',
...
class MyPopup extends StatefulWidget {
  final String type; // 'departure' or 'destination'
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    "Search ${widget.type == 'yourCountry' ? 'yourCountry' : 'passportCountry'}",
                suffixIcon: const Icon(Icons.search, color: Colors.grey),
              ),
            ),
            const SizedBox(height: 20),
            FutureBuilder(
              future: widget.type == 'yourCountry'
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  final data = widget.type == 'yourCountry'
                  ...
                  return Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (widget.type == 'yourCountry') {
                          final homeCountry = item;
                          return ListTile(
                            onTap: () {
                              controller.yourCountry.value = homeCountry.title;
                              Get.back();
                            },
                            title: Text(homeCountry.title),
                          );
                        } else if (widget.type == 'passportCountry') {
                          final destinationCountry = item;
                          return ListTile(
                            onTap: () {
                              controller.passportCountry.value =
                            ...
                            title: Text(destinationCountry.title),
                          );
                        } else {
